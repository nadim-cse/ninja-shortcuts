    ...
    public function NinjaSupportGetMenuItems(){
        ...
        $menu_items = [
            ...
            'fluent-forms-base' => [
                ...
                'title'  => 'Fluent Forms Base: '.FLUENTFORM_VERSION,
                'url'    => '#',
                'meta'   => [
                    'onclick' => 'copyLoremIpsum('.FLUENTFORM_VERSION.'); return false;',
                ]
            ],
            'fluent-forms-pro' => [
                'parent' => 'wpmanage-ninja-plugins-version',
                'title'  => 'Fluent Forms Pro: '.FLUENTFORMPRO_VERSION,
                'url'    => '#',
                'meta'   => [
                    'onclick' => 'copyLoremIpsum('.FLUENTFORMPRO_VERSION.'); return false;',
                ]
            ],
            'fluent-crm-base' => [
                'parent' => 'wpmanage-ninja-plugins-version',
                'title'  => 'FluentCRM base: '.FLUENTCRM_PLUGIN_VERSION,
                'url'    => '#',
                'meta'   => [
                    'onclick' => 'copyLoremIpsum('.FLUENTCRM_PLUGIN_VERSION.'); return false;',
                ]
            ],
            'fluent-crm-pro' => [
                'parent' => 'wpmanage-ninja-plugins-version',
                'title'  => 'FluentCRM Pro: '.FLUENTCAMPAIGN_PLUGIN_VERSION,
                'url'    => '#',
                'meta'   => [
